        ...
        public static void Write(string msg)
        {
            ...
            if (color_match.Success)
            {
                ...
                while (color_match.Success)
                {
                    ...
                    if (color_match.Value.StartsWith("{BC=", StringComparison.OrdinalIgnoreCase))
                    {
                    ...
                    else if (color_match.Value.Equals("{/BC}", StringComparison.OrdinalIgnoreCase)) 
                    {
                        Console.BackgroundColor = GetLastColorAndRemoveFromHistory(background_color_history, initial_background_color);
                    }
                    else if (color_match.Value.StartsWith("{FC=", StringComparison.OrdinalIgnoreCase)) 
                    {
